            ...
            <div class="col-md-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h3 class="card-title mb-0 text-primary">{{ \Carbon\Carbon::parse($pengembalian->tanggal_pinjam)->translatedFormat('l, d F Y') }}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h3 class="card-title mb-0 text-primary">{{ \Carbon\Carbon::parse($pengembalian->tanggal_kembali)->translatedFormat('l, d F Y') }}</h3>
                        </div>
                    </div>
                </div>
            </div>
