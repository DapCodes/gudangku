...
@section('page-title', 'Data Barang Masuk / Tambah')
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('brg-masuk.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    @endphp
                    @if ($status == 'RPL')
                        <input type="text" name="deskripsi" id="deskripsi" value="RPL" hidden>
                    @endif
                    @if ($status == 'TBSM')
                        <input type="text" name="deskripsi" id="deskripsi" value="TBSM" hidden>
                    @endif
                    @if ($status == 'TKRO')
                        <input type="text" name="deskripsi" id="deskripsi" value="TKRO" hidden>
                    @endif
                    @if ($status == 'admin')
                        <div class="row mb-3">
